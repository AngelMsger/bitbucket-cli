...
type Activity struct {
	...
	// System marks an activity generated by Bitbucket rather than a human review action.
...
type PRListOpts struct {
	...
	Author    string
	Reviewer  string
	FilterAll bool   // permit an explicit full-repository scan for emulated filters
