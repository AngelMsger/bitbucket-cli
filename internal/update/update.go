...
const DefaultEndpoint = "https://api.github.com/repos/angelmsger/bitbucket-cli/releases/latest"
...
const EndpointEnv = "BITBUCKET_RELEASE_API"
...
func compare(current, latest string) Status {
	...
	if less(cur, lat) {
		...
		st.Detail = fmt.Sprintf(
			...
			current, latest, "https://github.com/angelmsger/bitbucket-cli/releases/latest")
		return st
	}
