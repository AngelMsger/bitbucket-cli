...
// Flavor values for the Bitbucket backend.
const (
	FlavorAuto       = "auto"
	FlavorCloud      = "cloud"
...
const (
	...
	ContextSourceEnv     = "env"             // BITBUCKET_CONTEXT
...
// NamedContext is one named Bitbucket server profile inside the config file.
...
type Defaults struct {
	...
	// Workspace is the default Bitbucket workspace (Cloud) or project key
...
// this invocation (via --use-context or BITBUCKET_CONTEXT) rather than fallen
