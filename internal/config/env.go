...
var envBindings = map[string]string{
	"BITBUCKET_AUTH_SCHEME":           fieldAuthScheme,
	"BITBUCKET_CREDENTIAL_URL":        fieldCredentialURL,
...
func layerFromVars(vars map[string]string, serviceOnly ...bool) map[string]string {
	...
	// set BITBUCKET_FLAVOR/scheme explicitly.
	...
	if v := vars["BITBUCKET_AUTH_SCHEME"]; v != "" {
		m[fieldAuthScheme] = v
	}
	return m
}
